...
<section class="djacc djacc-container djacc-toolbar djacc--hidden<?php echo esc_attr($style . $position . $align); ?>">
	<div class="djacc__panel">
		<ul class="djacc__list">
			...
			<li class="djacc__item">
				<button class="djacc__btn djacc__btn--read-mode" aria-label="<?php esc_attr_e('Read mode', 'dj-accessibility'); ?>" data-label="<?php esc_attr_e('Disable readmode', 'dj-accessibility'); ?>">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
						<g fill="none" stroke="#fff" stroke-width="2">
							<rect width="24" height="24" rx="4" stroke="none"/>
							<rect x="1" y="1" width="22" height="22" rx="3" fill="none"/>
